...
const Overview = () => {
  ...
  return (
    <div className="overview">
      <div className="overview__column__1">
      ...
      <div className="overview__column__2">
        <div className="overview__column__2__detail">
          <h6>Production Companies</h6>
          <div className="overview__column__2__product-company">
        ...
        {items.map((data) => (
          <div className="overview__column__2__detail" key={data.id}>
            <h6>{data.name}</h6>
            <p>
              <a href="!#">{data.value}</a>
            </p>
